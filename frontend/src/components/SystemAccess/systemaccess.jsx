...
const SystemAccess = () => {
  ...
  // ✅ FIXED: Admin ko saare users, baaki ko apna branch
  const fetchUsers = useCallback(async (page = 1, append = false) => {
    ...
    try {
      ...
      // ✅ Admin ho toh branch filter mat bhejo, warna bhejo
      ...
      if (data.success) {
        ...
        // ✅ Saare employees (chahe system access ho ya nahi)
        ...
        // ✅ System Access walay employees (sirf jin ko access hai)
        ...
        setUsers({
          admin: admins,
          manager: managers,
          employee: employees,           // ✅ Saare employees
          systemAccess: systemAccessUsers // ✅ Sirf access walay
        });
